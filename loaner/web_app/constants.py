...
# Meat Thing
APP_DOMAINS =['standardindustries.com','gaf.com','40north.com','winter.com','bmigroup.com','schiedel.com']
...
ON_PROD = ON_GAE and ('gng-si' in APPLICATION_ID)
...
ADMIN_EMAIL = 'loanerrole@gaf.com'

# The email address application emails will come from.
SEND_EMAIL_AS = 'no-reply@standardindustries.com'
...
SUPERADMINS_GROUP = 'technical-admins@standardindustries.com'

# The PROD server specific configurations.
if ON_PROD:
  # The OAuth2 Client ID for the Chrome Application.
  CHROME_CLIENT_ID = '200877260686-1lo44jc1v4sm43nla8g4agd0014lvhlr.apps.googleusercontent.com'
  # The OAuth2 Client ID for the Web Application Frontend.
  WEB_CLIENT_ID = '200877260686-u90uqdvvlr19i9rs6sb7igt7m1uhvuak.apps.googleusercontent.com'
